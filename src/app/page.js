      ...
      <section className="">
        <div className="grid max-w-screen-xl px-4 py-8 mx-suto  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-gray-500 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
          ...
          <ul className="grid grid-cols-1 gap-4 mt-8 lg:grid-cols-3">
            ...
            <li>
              <div className="relative block group">
                <img
                  src="https://imgsrv2.voi.id/YUO3RupX58MIYW-Km3_xOihKOaBe14hQUrP6EEkrQII/auto/1200/675/sm/1/bG9jYWw6Ly8vcHVibGlzaGVycy8yMzE5MjkvMjAyMjExMzAxNjE2LW1haW4uanBn.jpg"
                  className="object-cover w-full aspect-square"
                />
                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
            ...
            <li className="lg:col-span-2 lg:col-start-2 lg:row-span-2 lg:row-start-1">
              <div className="relative block group">
                <img
                  src="https://pashtush.in/cdn/shop/products/pashtush-pashmina-pashtush-mens-woven-ethnic-stole-extra-soft-bamboo-fibre-29238723379254.jpg?v=1628235133&width=1080"
                  className="object-cover w-full aspect-square"
                />
                <div className="absolute inset-0 flex flex-col items-start justify-end p-6">
